...
$sdkLines += ''
$sdkLines += '# Network (PSRAM enables larger buffers)'
$sdkLines += 'CONFIG_LWIP_SO_RCVBUF=y'
$sdkLines += 'CONFIG_LWIP_TCPIP_RECVMBOX_SIZE=16'
$sdkLines += 'CONFIG_LWIP_UDP_RECVMBOX_SIZE=12'
$sdkLines += 'CONFIG_LWIP_MAX_SOCKETS=16'
$sdkLines += ''
$sdkLines += '# WiFi buffers — C5 SRAM limited, keep conservative even with PSRAM'
...
$sdkLines += ''
$sdkLines += '# Memory (C5 HP SRAM 384KB + N8R8 8MB Quad SPI PSRAM)'
...
$sdkLines += 'CONFIG_SPIRAM_USE_MALLOC=y'
$sdkLines += 'CONFIG_SPIRAM_TRY_ALLOCATE_WIFI_LWIP=y'
$sdkLines += 'CONFIG_SPIRAM_MALLOC_ALWAYSINTERNAL=16384'
$sdkLines += 'CONFIG_SPIRAM_IGNORE_NOTFOUND=y'
$sdkLines += 'CONFIG_SPIRAM_BOOT_INIT=y'
$sdkLines += ''
