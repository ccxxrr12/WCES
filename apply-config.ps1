...
$sdkLines += 'CONFIG_LWIP_TCPIP_RECVMBOX_SIZE=24'
$sdkLines += 'CONFIG_LWIP_UDP_RECVMBOX_SIZE=16'
$sdkLines += 'CONFIG_LWIP_MAX_SOCKETS=20'
$sdkLines += ''
$sdkLines += '# WiFi buffers — PSRAM relieves SRAM pressure, allow larger pools'
$sdkLines += 'CONFIG_ESP_WIFI_DYNAMIC_TX_BUFFER=y'
$sdkLines += 'CONFIG_ESP_WIFI_DYNAMIC_TX_BUFFER_NUM=16'
$sdkLines += 'CONFIG_ESP_WIFI_DYNAMIC_RX_BUFFER_NUM=32'
$sdkLines += 'CONFIG_ESP_WIFI_STATIC_RX_BUFFER_NUM=12'
$sdkLines += ''
$sdkLines += '# Memory (C5 400KB SRAM + N8R8 8MB Quad SPI PSRAM)'
$sdkLines += 'CONFIG_ESP_MAIN_TASK_STACK_SIZE=7168'
$sdkLines += ''
$sdkLines += '# PSRAM — N8R8 module has 8MB Quad SPI PSRAM, now enabled'
$sdkLines += 'CONFIG_SPIRAM=y'
$sdkLines += 'CONFIG_SPIRAM_MODE_QUAD=y'
$sdkLines += 'CONFIG_SPIRAM_SPEED_80M=y'
$sdkLines += 'CONFIG_SPIRAM_USE_CAPS_ALLOC=y'
$sdkLines += 'CONFIG_SPIRAM_IGNORE_NOTFOUND=y'
$sdkLines += ''
$sdkLines += '# WASM deferred to RZ/G2L native Rust (edge_module_engine.rs)'
