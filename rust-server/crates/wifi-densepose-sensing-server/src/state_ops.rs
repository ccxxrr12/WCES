...
use crate::types::{
    ...
    VITAL_EMA_ALPHA, VITAL_MEDIAN_WINDOW,
};
...
// Per-node smooth_and_classify_node and smooth_vitals_node removed (ADR-142).
// Motion detection now fully from signal_pipeline; vitals from VitalsBridge (upstream IIR path).
